...
public class AddJobCommandHandler : ResponseHandler, IRequestHandler<AddJobCommand, Response<string>>
{
    ...
    public AddJobCommandHandler(IJobManager jobManager, ICompanyManager companyManager, IMapper mapper, IStringLocalizer<SharedResources> localizer) : base(localizer)
    {
